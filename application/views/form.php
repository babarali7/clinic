<div class="content">
         ...
         <div class='col-md-12'>
          ...
          <div id="toolbar-container">
           ...
           <form method="post" action="gone.php">
             ...
             <div id="editor-container" name="text"></div> 
            
            <textarea name="tex" style="display: none;"  id="hiddenarea" ></textarea>
             
             <input type="button" name="Save" onclick="call_me();" value="vutt">
      ...
      <script type="text/javascript">
          ...
          function call_me() {
             ...
             var xx = myEditor.children[0].innerHTML


           //   var x = $("#hiddenarea").val($("#editor-container").html());
